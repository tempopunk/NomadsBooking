...
public class HotelController {
	...
	@GetMapping("/hotel_agent/hotel/id")
	...
	public ResponseEntity<Hotel> getHotelById( @RequestParam int id){
		return ResponseEntity.ok(hotelService.searchById(id));
...
//	}
	@DeleteMapping("/hotel_agent/hotel/deleteroom")
	public ResponseEntity<String> removeRoom(@RequestParam int roomId,@RequestParam int hotelId) {
		return ResponseEntity.ok(hotelService.deleteRoom(roomId,hotelId));
	}
...
//    }
    ...
    public ResponseEntity<List<Booking>> viewPendingBooking(@PathVariable int userId){
    	List<Booking> booking = hotelService.viewPendingBooking(userId);
    	if(booking.isEmpty()) {
    		return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
    	}
    ...
    public ResponseEntity<List<Booking>> viewPaidBooking(@PathVariable int userId){
    	List<Booking> booking = hotelService.viewPaidBooking(userId);
    	if(booking.isEmpty()) {
    		return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
    	}
    	return ResponseEntity.ok(booking);
    ...
    @GetMapping("hotel_agent/booking/byHotelId/{hotelId}")
    public ResponseEntity<List<Booking>> viewHotelBooking(@PathVariable int hotelId){
    	List<Booking> booking = hotelService.viewHotelBooking(hotelId);
    	if(booking.isEmpty()) {
    		return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
    	}
    	return ResponseEntity.ok(booking);
    ...
    @GetMapping("package_agent/booking/byPackageId/{packageId}")
    public ResponseEntity<List<Booking>> viewPackageBooking(@PathVariable int packageId){
    	List<Booking> booking = hotelService.viewPackageBooking(packageId);
    	if(booking.isEmpty()) {
    		return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
    	}
    	return ResponseEntity.ok(booking);
